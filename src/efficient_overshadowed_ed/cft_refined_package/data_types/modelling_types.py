...
from efficient_overshadowed_ed.cft_refined_package.utilities.general_utils import get_logger, merge_spans, sort_spans
...
class BatchElementTns(NamedTuple):
    ...
    aug_token_id_values: Tensor = None  # shape = (seq_len, )
...
class BatchedElementsTns(NamedTuple):
    ...
    aug_token_id_values: Tensor = None  # shape = (bs, seq_len)
